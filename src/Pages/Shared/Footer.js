                ...
                <footer class="py-5">
                    ...
                    {/* <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                        ...
                        <ul class="list-unstyled d-flex">
                            <li class="ms-3"><Link class="link-dark" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#twitter" /></svg></Link></li>
                            <li class="ms-3"><Link class="link-dark" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#instagram" /></svg></Link></li>
                            <li class="ms-3"><Link class="link-dark" href="#"><svg class="bi" width="24" height="24"><use xlink:href="#facebook" /></svg></Link></li>
                        </ul>
                    </div> */}
                </footer>
            </div>
