        ...
        <div className="App">
            ...
            <div className=" ">
...

                {
                    data.map((d, i) => {
                        return <div key={i} >
                            <b>Name: </b>{d.jobTitle}<br />
                            <b>Year: </b>{d.organization}<br />
                            <b>Color: </b>{d.deadline}<br />
                            <b>Pantone value: </b>{d.applyStatus}
                        </div>
                    })
                }
