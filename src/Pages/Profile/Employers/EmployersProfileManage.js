      ...
      <form onSubmit={handleEmployersDocUpdate}>
        <div className=" row">
          ...
          <div className=" col-md-3">
            ...
            >
              <option defaultValue={storedData.organizationType}>
                {storedData.organizationType}
              </option>
        ...
        <label htmlFor="companyNameBn">
          {" "}
          <b> Company Name Bengali</b>
        </label>
        <input
          onChange={handleInputChange}
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            ...
            <div className=" d-flex">
              ...
              >
                <option defaultValue={storedData.companySize}>
                  {storedData.companySize}
                </option>
