    ...
    return (
        <div className='my-5 col-lg-10 mx-auto'>
            ...
            <div className="d-flex  justify-content-center mt-4">
                <input type="text" id="phone-search" placeholder="Keyword" className="form-control  w-25" aria-describedby="kewordHelp" />
                <input type="text" id="phone-search" placeholder="Organization Type" className="form-control seach  mx-2 w-25" aria-describedby="locationHelp" />
